...
const Register = () => {
  const { register, handleSubmit, reset, formState: form, getFieldState } = useForm<IRegisterRequest>({ resolver: zodResolver(schema), mode: 'onTouched' });
          ...
          <div className="card">
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit(handleRegister)} className="needs-validation" noValidate>
                <div className="row g-3">
                  <div className="col-12">
                    ...
                    <div className="input-group has-validation">
                      ...
                      <input type="text" {...register('firstName')} name='firstName' className={`form-control ' ${form.errors.firstName ? 'is-invalid' : ''} ${isFieldValid('firstName') ? 'is-valid' : ''}`} id="firstName" placeholder="First name" disabled={isLoading} required />
                  ...
                  <div className="col-12">
                    ...
                    <div className="input-group has-validation">
                      <span className="input-group-text"><i className="bi bi-person-vcard"></i></span>
                      <input type="text" {...register('lastName')} name='lastName' className={`form-control ' ${form.errors.lastName ? 'is-invalid' : ''} ${isFieldValid('lastName') ? 'is-valid' : ''}`} id="lastName" placeholder="Last Name" disabled={isLoading} required />
                  ...
                  <div className="col-12">
                    ...
                    <div className="input-group has-validation">
                      ...
                      <input type="password" {...register('password')} name='password' className={`form-control ' ${form.errors.password ? 'is-invalid' : ''} ${isFieldValid('password') ? 'is-valid' : ''}`} placeholder="Password" disabled={isLoading} required />
                ...
                <hr className="my-4" />
                <div className="col">
                  <button disabled={form.isSubmitting || isLoading} className="btn btn-primary" type="submit" >
                    {(form.isSubmitting || isLoading) && <span className="spinner-border spinner-border-sm" aria-hidden="true"></span>}
                    <span role="status">{(form.isSubmitting || isLoading) ? 'Loading...' : 'Register'}</span>
                  </button>
                </div>
              </form>
              <hr className="my-3" />
