...
const StudentDetails = () => {
  ...
  const { register, handleSubmit, formState: form, getFieldState, unregister } = useForm<DocumentForm>({ resolver: zodResolver(schema), mode: 'onTouched' });
                ...
                <div className="row align-items-center">
                  <div className="col-md-3">
                    <div className="text-center border-end">
                      <img src={documentData.data.document.icon} className="avatar-xxl" alt="" />
                    </div>
                  </div>
