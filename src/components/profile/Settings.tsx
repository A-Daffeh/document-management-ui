          ...
          <ul className="list-group list-group-sm">
            <li className="list-group-item has-icon">
              ...
              <div className="form-check form-switch ml-auto">
                ...
                checked={!userData.data.user.accountNonExpired} 
                name={AccountSettings.EXPIRED} 
                disabled={userData?.data.user.role === 'USER'}
            ...
            <li className="list-group-item has-icon">
              ...
              <div className="form-check form-switch ml-auto">
                <input type="checkbox" 
                onChange={(event) => toggleSettings(event.target.name as AccountSettings)} 
                checked={!userData.data.user.accountNonLocked} 
            ...
            <li className="list-group-item has-icon">
              ...
              <div className="form-check form-switch ml-auto">
                <input type="checkbox" 
                onChange={(event) => toggleSettings(event.target.name as AccountSettings)} 
                checked={userData.data.user.enabled} 
          ...
          <ul className="list-group list-group-sm">
            <li className="list-group-item has-icon">
              ...
              <div className="form-check form-switch ml-auto">
                <input type="checkbox" 
                onChange={(event) => toggleSettings(event.target.name as AccountSettings)} 
                checked={!userData.data.user.credentialsNonExpired} 
                disabled={true}
                readOnly={true}
